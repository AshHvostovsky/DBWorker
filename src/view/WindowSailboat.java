...
public class WindowSailboat{
    ...
    public WindowSailboat(JFrame jFrame, MyTableModel_v2 myTableModel) {
        this.myTableModel = myTableModel;
        this.dialog = new JDialog(jFrame, "Таблица парусников", true);
    ...
    public void init() {
        ...
        this.button_add = new JButton("Добавить парусник");
